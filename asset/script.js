(function () {
  ...
  // *** THAY ĐỔI 1: Đổi "var runAsync" thành "window.startTreeAnimation" ***
  ...
  // *** THAY ĐỔI 2: Xóa dòng "runAsync().start();" ở đây ***
  
})();

// *** THAY ĐỔI 3: Xóa toàn bộ khối "document.addEventListener("click", ...)" dùng để chơi nhạc ở đây ***